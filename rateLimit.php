...
class RateLimitMiddleware{
    public function __invoke($request, $handler)
    {
        ...
        $requests = 10; // maximum number of requests
    	$inmins = 1;    // in how many time (minutes)
    	...
    	if ($mustbethrottled == false) {
            ...
            $jsonResult->reason="You have been rate limited.";
...
class APIRateLimit
{
    ...
    {
    	$this->pdo = new PDO('mysql:host=localhost;dbname=u936088023_physioapp;charset=utf8', 'u936088023_physioapp', 'pRbC^sN8');
